...
public class Simulation implements SimulationInt {
    ...
    public double interruptionAverageDuration() {
    ...
    public void setAmountNotEntering(int amountNotEntering) {
    ...
    public Simulation(double clientsPerHour, double attentionAverageSpeed,
    ...
    private void addInterruptionEvent(Event lastEvent) {
        ...
        if (nextDeparture != 0) {
            double backup = nextDeparture;
            nextDeparture += interruptionDuration + getDurationChannel();
            wastedTime += nextDeparture - backup - interruptionDuration;
